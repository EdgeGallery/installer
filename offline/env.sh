...
export mep_images_mep_fe_repository="$REGISTRY_URL"edgegallery/mep-fe
...
export mep_images_elasticsearch_repository="$REGISTRY_URL"eg-common/elasticsearch
export mep_images_mep_tag="$EG_IMAGE_TAG"
export mep_images_mep_fe_tag="$EG_IMAGE_TAG"
...
export mep_images_mep_fe_pullPolicy=IfNotPresent
...
export mepm_images_osplugin_repository="$REGISTRY_URL"edgegallery/mecm-applcm-osplugin
...
export mepm_images_osplugin_tag="$EG_IMAGE_TAG"
export mepm_images_apprulemgr_tag="$EG_IMAGE_TAG"
export mepm_images_fe_tag="$EG_IMAGE_TAG"
...
export mepm_images_osplugin_pullPolicy=IfNotPresent
...
#Send Mail Config
export usermgmt_mail_enabled=false
export usermgmt_mail_host=example
export usermgmt_mail_port=25
export usermgmt_mail_sender=example
export usermgmt_mail_authcode=example
