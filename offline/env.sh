...
export mep_images_mep-fe_repository="$REGISTRY_URL"edgegallery/mep-fe
...
export mep_images_mep-fe_tag="$EG_IMAGE_TAG"
...
export mep_images_mep-fe_pullPolicy=IfNotPresent
